...
namespace RuuviCTRL.Infrastructure.Migrations
{
    ...
    [Migration("20210116222322_add location to breaches")]
    partial class addlocationtobreaches
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RuuviCTRL.Core.Entities.AssetSLAAgreement", b =>
                {
                    ...
                    b.HasKey("AssetId", "SlaAgreementId");

                    b.HasIndex("SlaAgreementId");

                    b.ToTable("AssetSLAAgreement");
                });
            ...
            modelBuilder.Entity("RuuviCTRL.Core.Entities.Breach", b =>
                {
                    ...
                    b.Property<bool>("HasLocationBreach")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("RuuviCTRL.Core.Entities.AssetSLAAgreement", b =>
                {
                    b.HasOne("RuuviCTRL.Core.Entities.Asset", "Asset")
                        .WithMany("AssetSlaAgreements")
                        .HasForeignKey("AssetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RuuviCTRL.Core.Entities.SLAAgreement", "SlaAgreement")
                        .WithMany("AssetSlaAgreements")
                        .HasForeignKey("SlaAgreementId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
